...
<input type="text" class="input-style" name="subject" placeholder="Enter the subject" required>
<hr>
<textarea class="input-style" name="body" placeholder="Enter the body" required></textarea>
<hr>
